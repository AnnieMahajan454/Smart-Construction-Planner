...
# Initialize LangChain LLM + Memory (with fallback for missing API key)
if openai_api_key:
    ...
    st.warning("⚠️ OpenAI API Key not found! AI chatbot features will be disabled. Set OPENAI_API_KEY environment variable to enable full functionality.")
    ai_enabled = False
    conversation = None
...
if st.button("Ask AI"):
    if user_question.strip() == "":
        ...
        st.info("🤖 AI chatbot is disabled. Please set the OPENAI_API_KEY environment variable to enable this feature.")