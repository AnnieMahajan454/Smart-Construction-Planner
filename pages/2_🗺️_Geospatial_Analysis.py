...
if geospatial_available:
    ...
    place = st.text_input("Enter a place name (e.g., 'San Francisco, CA', 'Manhattan, New York')", 
    ...
    if 'walk_graph' in st.session_state:
        ...
        if len(sample_nodes) > 0:
            center_node = st.selectbox("Select center node for isochrone", 
    ...
    if 'sample_points' in st.session_state:
        ...
        if st.button("Aggregate to H3 Hexagons"):
            try:
                ...
                # Original points
                scatter = ax1.scatter(sample_points['lon'], sample_points['lat'], 
                ...
                scatter2 = ax2.scatter(hex_lons, hex_lats, 
