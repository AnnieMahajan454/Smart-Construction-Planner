...
def estimate_project_timeline(
    ...
    # Base construction rates (days per mÂ²) by project type
    base_rates = {
        'Residential': 0.8,
        'Commercial': 1.2,
        'Industrial': 1.0,
...
def main():
    ...
    with st.sidebar.expander("Advanced Options"):
        project_start_month = st.selectbox(
            "Project Start Month",
            range(1, 13),
    ...
    tab1, tab2, tab3, tab4 = st.tabs([
        "📊 Timeline Analysis", "🌱 Sustainability Assessment",
    ...
    with tab3:
        ...
        with col1:
            ...
            st.markdown(
                f"**Overall Risk Level:** <span style='color: {risk_color}'>{risk_assessment.risk_level.value}</span>",
